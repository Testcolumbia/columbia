/*
* Classname                                                        SVP_Sm_vpv_009_VOD_Mp3_SL_Disabled 
*
* Version info
*
* Copyright notice
	...
	public void test_SVP_Sm_vpv_009_VOD_Mp3_SL_Disabled() throws Exception {
		{
		   ...
		   if (selenium.isElementPresent(EnvObjectMap_Rep.drp_selectTimeZoneCVP))
			...
			assertTrue("Sm_vpv_009","Verify that asx file is generated successfully for a SVP containg .mp3 file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, VAR_MP3_fileName));
			assertTrue("Sm_vpv_009","Verify that http protocol is displayed in asx file for a SVP containg .mp3 file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
			utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
