/*
* Classname                                                        SVP_Sm_vpv_006_EGCupload_FLV 
*
* Version info
*
* Copyright notice
	...
	public void test_SVP_Sm_vpv_006_EGCupload_FLV() throws Exception {
		{
		   ...
		   String SVP_url = Var_Columbia_vpURL + VAR_DomSocial + "/home.vp"; 
			...
			//To verify the asx file
	   		assertTrue("Sm_vpv_006","Verify that asx file for on-demand program with FLV file is generated successfully.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
	   		//Verify that the stream is displayed correct in the asx file
	   		assertTrue("Sm_vpv_006","Social VP: Ensure that FLV file is uploaded from EGC portal and correctly displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource, VAR_EGCprogramName)); 
	   		utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
