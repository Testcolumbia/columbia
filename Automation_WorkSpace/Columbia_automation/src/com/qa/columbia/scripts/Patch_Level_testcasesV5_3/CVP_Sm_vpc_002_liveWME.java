/*
* Classname                                                        CVP_Sm_vpc_002_liveWME 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_002_liveWME extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_002_liveWME() throws Exception {
		{
			try {
				setUp();
			...
			assertTrue("Sm_vpc_002","Verify that Live Broadcast is started successfully.",date,selenium.isElementPresent(EnvObjectMap_Rep.btn_stopBroadcast));
		...
		//	selenium.selectWindow("Qumu Program Browser Home");
			...
			assertTrue("Sm_vpc_002","Verify that asx file is generated successfully.",date,utilityFunction.assertTextContains(htmlsource2, VAR_EncoderProfileName));
			...
			assertTrue("Sm_vpc_002","Verify that multicast stream is displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource2, "http://" + VAR_WMSHost +"/WMSControl/qumu_"));
