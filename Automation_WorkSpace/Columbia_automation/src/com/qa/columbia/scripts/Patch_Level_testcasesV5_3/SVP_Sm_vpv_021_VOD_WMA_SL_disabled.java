/*
* Classname                                                       SVP_Sm_vpv_021_VOD_WMA_SL_disabled
*
* Version info
*
* Copyright notice
	...
	public void test_SVP_Sm_vpv_021_VOD_WMA_SL_disabled() throws Exception {
		{
        	...
        	Create_Program.test_Create_vodProgram(selenium, str_ProgName, VAR_WMA_fileName);
			...
			assertTrue("Sm_vpv_021","Verify that asx file is generated successfully for a SVP containg .wma file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, VAR_WMA_fileName));
			assertTrue("Sm_vpv_021","Verify that http protocol is displayed in asx file for a SVP containing .wma file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
			utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
