/*
* Classname                                                        CVP_Sm_vpc_017_unapproveProgramAccess
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_017_unapproveProgramAccess extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_017_unapproveProgramAccess() throws Exception {
		{
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			assertTrue("Sm_vpc_017","Ensure that newely created program is in unapproved status.",date,selenium.isTextPresent(VAR_programName));
			...
			assertTrue("Sm_vpc_017","Classic VP: Ensure that unapproved programs are not accessible to viewers.",date,!selenium.isElementPresent(EnvObjectMap_Rep.lnk_programNameCVP + VAR_programName));
			//Reusable action to login
			Login.test_login(selenium, VAR_USR, VAR_PWD, VAR_DomClassic);	
			//Navigate to Domains
    		selenium.click(EnvObjectMap_Rep.LNK_Domains);
    		//wait for loading the page
