/*
* Classname                                                        CVP_Sm_vpc_009_vod_QT 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_009_vod_QT extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_009_vod_QT() throws Exception {
		{
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
	      ...
	      //  System.out.println(htmlsource1);
	        //Verify that asx file is generated
	   		assertTrue("Sm_vpc_009","Verify that asx file for on-demand program with QT file is generated successfully.",date,utilityFunction.assertTextContains(htmlsource1, "src="));
	   		//Verify that the stream is displayed correct in the asx file
	   		assertTrue("Sm_vpc_009","Verify that correct storage host and mount point is displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource1, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));        	
	   		utilityFunction=null;
			}
			catch(Exception e)
			{
