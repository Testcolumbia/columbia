/*
* Classname                                                        CVP_Sm_vpc_008_vod_msProducer 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_008_vod_msProducer extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_008_vod_msProducer() throws Exception {
		{
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
        	...
        	assertTrue("Sm_vpc_008","Classic VP: Ensure that an On Demand program (MS-Producer file) plays with HTTP delivery option.",date,selenium.isElementPresent(EnvObjectMap_Rep.lnk_videoProgramCVP + VAR_streamingMedia));
        	utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
