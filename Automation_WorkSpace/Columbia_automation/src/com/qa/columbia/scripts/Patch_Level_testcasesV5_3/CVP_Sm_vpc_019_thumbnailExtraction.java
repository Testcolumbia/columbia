/*
* Classname                                                        CVP_Sm_vpc_019_thumbnailExtraction 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_019_thumbnailExtraction extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_019_thumbnailExtraction() throws Exception {
		{ 
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
		    ...
		    assertTrue("Sm_vpc_019","Classic VP: Ensure that thumbnails are extracted for WMV file from Content page.",date,selenium.isElementPresent(EnvObjectMap_Rep.radio_selectthumbnail));
		    //wait
		    //utilityFunction.waitForChangesToReflect();
			...
			assertTrue("Sm_vpc_019","Classic VP: Ensure that extracted thumbnail is displayed successfully on Content page.",date,selenium.isTextPresent(VAR_streamingMedia+"_thumbnail"));
			//logout of VCC
			utilityFunction=null;
			}catch(Exception e)
			{
