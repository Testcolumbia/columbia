/*
* Classname                                                        CVP_Sm_vpc_012_PinProtected_Automated_RSSdisc4k 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_012_PinProtected_Automated_RSSdisc4k extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_012_PinProtected_Automated_RSSdisc4k() throws Exception {
		{
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			for (int i =4;i<=10;i++)
			{
				if(selenium.getText(MessageFormat.format(EnvObjectMap_Rep.lnk_DiscoveredProgram, i)).startsWith(VAR_ProgPrefix))
					...
					{
						pinStatus = true;
						assertTrue("Sm_vpc_012","Verify that automated file broadcast program is created for a pin-protected live call.",date,pinStatus);
					}
					break;
					}			
			}
			...
			assertTrue("Sm_vpc_012","Verify that Pin is asked on viewer portal on plying the automated file broadcast program, created for a pin-protected call.",date,selenium.isElementPresent(EnvObjectMap_Rep.txt_privateCode));
			...
			assertTrue("Sm_vpc_012","Verify that asx file is generated successfully for the discovered automated file broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, Var_LiveProgramName + "hi"));
			assertTrue("Sm_vpc_012","Verify that mms protocol is displayed in asx file for the discovered automated file broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, "mms"));
			selenium.close();
