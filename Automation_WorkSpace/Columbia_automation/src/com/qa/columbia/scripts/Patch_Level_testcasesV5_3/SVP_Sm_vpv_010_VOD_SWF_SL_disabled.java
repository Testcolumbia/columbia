/*
* Classname                                                        SVP_Sm_vpv_010_VOD_SWF_SL_disabled
*
* Version info
*
* Copyright notice
...
public class SVP_Sm_vpv_010_VOD_SWF_SL_disabled extends TesterAsserter {
	...
	public void test_SVP_Sm_vpv_010_VOD_SWF_SL_disabled() throws Exception {
		...
		//	assertTrue("SVP_VOD_SWF_SL_disabled","Verify that asx file is generated successfully for a SVP containing .swf file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, VAR_SWFfile));
			assertTrue("Sm_vpv_010","Verify that http protocol is displayed in asx file for a SVP containing .swf file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
			utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
