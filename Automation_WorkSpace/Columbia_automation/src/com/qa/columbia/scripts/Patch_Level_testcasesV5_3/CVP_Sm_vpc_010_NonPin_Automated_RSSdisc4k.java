/*
* Classname                                                        CVP_Sm_vpc_010_NonPin_Automated_RSSdisc4k 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_010_NonPin_Automated_RSSdisc4k extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_010_NonPin_Automated_RSSdisc4k() throws Exception {
		{
			try{
				setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			for (int i =4;i<=10;i++)
			{
				if(selenium.getText(MessageFormat.format(EnvObjectMap_Rep.lnk_DiscoveredProgram, i)).startsWith(VAR_ProgPrefix))
					...
					assertTrue("Sm_vpc_010","Verify that automated file broadcast program is created for the live call.",date,selenium.isTextPresent(Var_LiveProgramName));
					break;
					}			
			}
			...
			assertTrue("Sm_vpc_010","Verify that asx file is generated successfully for the discovered automated file broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, Var_LiveProgramName + "hi"));
			assertTrue("Sm_vpc_010","Verify that mms protocol is displayed in asx file for the discovered automated file broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, "mms"));
			selenium.close();
