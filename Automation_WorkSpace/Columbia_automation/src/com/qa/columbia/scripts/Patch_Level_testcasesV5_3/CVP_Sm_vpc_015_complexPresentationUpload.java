/*
* Classname                                                        CVP_Sm_vpc_015_complexPresentationUpload 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_015_complexPresentationUpload extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_015_complexPresentationUpload() throws Exception {
		{
			try{
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			//utilityFunction.waitForElementToVisible(selenium, VAR_complexPresentationName, 300)	;
			Thread.sleep(5000);
			//Check Point to test that RSS Encoder is created
			assertTrue("Sm_vpc_015","Classic VP: Ensure that Complex presentation file is uploaded in Content page.",date,selenium.isTextPresent(VAR_complexPresentationName));
			utilityFunction=null;
			}
			catch(Exception e)
			{
