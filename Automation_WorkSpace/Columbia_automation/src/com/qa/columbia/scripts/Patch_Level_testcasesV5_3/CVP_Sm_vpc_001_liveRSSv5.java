	...
	public void test_CVP_Sm_vpc_001_liveRSSv5() throws Exception {
		{
			...
			Launch_LBC.test_LaunchLBC(selenium, "Sm_vpc_001", Var_LiveProgramName, Var_ArchiveOfLiveProgram);
			...
			assertTrue("Sm_vpc_001","Verify that asx file is generated successfully.",date,utilityFunction.assertTextContains(htmlsource2, VAR_EncoderProfileName));
			...
			assertTrue("Sm_vpc_001","Verify that multicast stream is displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource2, "http://" + VAR_WMSHost +"/WMSControl/qumu_"));
