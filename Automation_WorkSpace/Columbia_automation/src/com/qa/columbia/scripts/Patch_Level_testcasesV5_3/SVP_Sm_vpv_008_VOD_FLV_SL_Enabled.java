/*
* Classname                                                        SVP_Sm_vpv_008_VOD_FLV_SL_Enabled
*
* Version info
*
* Copyright notice
	...
	public void test_SVP_Sm_vpv_008_VOD_FLV_SL_Enabled() throws Exception {
		{
			...
			assertTrue("Sm_vpv_008","Verify that asx file is generated successfully for a SVP containg .flv file with HTTP delivery option and SL enabled.",date,utilityFunction.assertTextContains(htmlsource, VAR_FLV_fileName));
			assertTrue("Sm_vpv_008","Verify that http protocol is displayed in asx file for a SVP containg .flv file with HTTP delivery option and SL enabled.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
			utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
