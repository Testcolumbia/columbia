/*
* Classname                                                        CVP_Sm_vpc_013_PinProtected_VOD_RSSdisc4k 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_013_PinProtected_VOD_RSSdisc4k extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_013_PinProtected_VOD_RSSdisc4k() throws Exception {
		{
        try{
	        setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
		...
		assertTrue("Sm_vpc_013","Verify that Pin is asked on playing the discovered pin protected On-demand program on viewer portal.",date,selenium.isElementPresent(EnvObjectMap_Rep.txt_privateCode));
		...
		//Verify the asx file
		assertTrue("Sm_vpc_013","Verify that asx file is generated successfully for the discovered pin protected On-demand program.",date,utilityFunction.assertTextContains(htmlsource2, Var_VODProgramName + "hi.asf"));
		assertTrue("Sm_vpc_013","Verify that http protocol is displayed in asx file for the discovered pin protected On-demand program.",date,utilityFunction.assertTextContains(htmlsource2, "http"));
