/*
* Classname                                                        Sm_vpc_013_VOD_RSSdisc4k_PinProtected 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_013_VOD_RSSdisc4k_PinProtected extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_013_VOD_RSSdisc4k_PinProtected() throws Exception
	{
		{
			try
			{
				...
				String localVariableFile ="CVP_Sm_vpc_013_VOD_RSSdisc4k_PinProtected.xml";
				...
				for (int i =4;i<=10;i++)
				{
					...
					if(selenium.getText(EnvObjectMap_Rep.lbl_pinStatusVODSummaryPage).equals("Yes"))
					{
						...
						assertTrue("Sm_vpc_013","Verify that Pin Protected On-demand program is created for the Pin Protected call.",date,pinStatus);
					}
					break;
					}
				}	
				...
				assertTrue("Sm_vpc_013","Verify that Pin is asked on viewer portal on playing the On-demand program, created for a pin-protected call.",date,selenium.isElementPresent(EnvObjectMap_Rep.txt_privateCode));
				...
				//Verify the asx file
				assertTrue("Sm_vpc_013","Verify that asx file is generated successfully for the discovered On-demand program.",date,utilityFunction.assertTextContains(htmlsource2, Var_VODProgramName + "hi.asf"));
				assertTrue("Sm_vpc_013","Verify that http protocol is displayed in asx file for the discovered On-demand program.",date,utilityFunction.assertTextContains(htmlsource2, "http"));
