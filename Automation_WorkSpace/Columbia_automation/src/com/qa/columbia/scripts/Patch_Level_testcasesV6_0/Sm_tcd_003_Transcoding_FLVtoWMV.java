/*
* Classname                                                        Transcoding_Sm_tcd_003_FLVtoWMV 
*
* Version info
*
* Copyright notice
...
public class Sm_tcd_003_Transcoding_FLVtoWMV extends TesterAsserter {
	...
	public void test_Sm_tcd_003_Transcoding_FLVtoWMV() throws Exception 
		{
		try{	
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			String str_path ="Global_variables.xml";
			String local_path ="Sm_tcd_003_TranscodeFLVfiletoWMV.xml";
    		...
    		//Wait for loading the page
     				 ...
     				 for(int sec = 0;; sec++) {
     					 ...
     					 try { 
     						...
     						/*	 utilityFunction.waitForChangesToReflect();*/
     							 ...
     							 utilityFunction.waitForChangesToReflect();
     							 utilityFunction.waitForChangesToReflect();
     							 assertTrue("Sm_tcd_003","Verify that file has transcoded successfully",date,selenium.isTextPresent(VAR_FLV_fileName));
     		...
     		for (int secs = 0;; secs++) {
				 ...
				 try { 
					 ...
					 {
						 assertTrue("Sm_tcd_003","Ensure that Transcoded file is displayed on Content page.",date,selenium.isTextPresent(VAR_FLV_fileName +","+" "+"transcoded"));	
     		 ...
     		 if (str_var.contains(VAR_FLV_fileName +","+" "+"transcoded")){
     			 ...
     			 for (int secs = 0;; secs++) {
     				 ...
     				 try { 
     					 ...
     					 {
     						 assertTrue("Sm_tcd_003","Ensure that ingest is completed for the transcoded file.",date,selenium.isTextPresent("INGESTCOMPLETE"));
     					 }
     					 break; } catch (Exception e) {}
     					 Thread.sleep(1000);
     			 ...
     			 Create_Program.create_VODProgram(selenium, str_ProgName,"", VAR_TranscodedFLV_fileName);
     			 //Wait
     			 utilityFunction.waitForChangesToReflect();
    			 ...
    			 assertTrue("Sm_tcd_003","Verify that asx file is generated successfully for a WMV file transcoded into a flv file.",date,utilityFunction.assertTextContains(htmlsource, VAR_FLV_fileName+","+" "+"transcoded"));
    			 assertTrue("Sm_tcd_003","Verify that wmv file is displayed in the asx file for a flv file transcoded into a wmv file.",date,utilityFunction.assertTextContains(htmlsource, "barsandtone.wmv"));
    			utilityFunction=null;
			}catch(Exception e)
			{
			e.printStackTrace();
