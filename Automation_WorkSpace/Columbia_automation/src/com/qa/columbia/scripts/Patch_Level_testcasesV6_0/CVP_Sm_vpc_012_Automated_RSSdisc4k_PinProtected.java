/*
* Classname                                                        CVP_Sm_vpc_012_Automated_RSSdisc4k_PinProtected 
*
* Version info
*
* Copyright notice
...
public class CVP_Sm_vpc_012_Automated_RSSdisc4k_PinProtected extends TesterAsserter {
	...
	public void test_CVP_Sm_vpc_012_Automated_RSSdisc4k_PinProtected() throws Exception
	{
		{
			try
			{
				...
				String localVariableFile ="CVP_Sm_vpc_012_Automated_RSSdisc4k_PinProtected.xml";
				...
				utilityFunction.waitForElementToVisible(selenium, EnvObjectMap_Rep.chk_rssv6EnableArchive, 300);
				...
				for (int y = 0;y<=16;y++)
				{
					...
					{
						System.out.println("discovery-0");
				...
				for (int i =4;i<=10;i++)
				{
					...
					if(selenium.getText(EnvObjectMap_Rep.lbl_pinStatusAutomatedSummaryPage).equals("Yes"))
					{
						...
						assertTrue("Sm_vpc_012","Verify that Pin-protected Automated File Broadcast program is created for the Pin Protected call.",date,pinStatus);
					}
					break;
					}
				}	
				...
				assertTrue("Sm_vpc_012","Verify that Pin is asked on viewer portal on playing the automated file broadcast program, created for a pin-protected call.",date,selenium.isElementPresent(EnvObjectMap_Rep.txt_privateCode));
				...
				//Verify the asx file
				assertTrue("Sm_vpc_012","Verify that asx file is generated successfully for the discovered Automated File Broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, Var_AutomatedLiveProgramName + "hi"));
				assertTrue("Sm_vpc_012","Verify that http protocol is displayed in asx file for the discovered Automated File Broadcast program.",date,utilityFunction.assertTextContains(htmlsource2, "http"));
