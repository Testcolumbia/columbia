...
public class SVP_VOD_Mp3_SL_Disabled extends TesterAsserter {
	...
	public void test_SVP_VOD_Mp3_SL_Disabled() throws Exception {
		{
			try {
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			String str_path ="Global_variables.xml";
			String local_path ="SVP_VOD_Mp3_SLDisabled.xml";
			...
			String VAR_MP3file = utilityFunction.GetValue(local_path ,"VAR_fileType");
			//Variable for mp3 file name
			String VAR_MP3_fileName = utilityFunction.GetValue(local_path ,"VAR_MP3_fileName");
			...
			//Reusable action for Login to VCC
     		...
     		Create_Program.test_Create_vodProgram(selenium, str_ProgName, VAR_MP3_fileName);
		...
		//	utilityFunction.assertTextContains(htmlsource, VAR_MP3_fileName);
			//utilityFunction.assertTextContains(htmlsource, VAR_SiteURL +":80");   
			assertTrue("SVP_VOD_Mp3_SL_Disabled","Verify that asx file is generated successfully for a SVP containg .mp3 file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, VAR_MP3_fileName));
			assertTrue("SVP_VOD_Mp3_SL_Disabled","Verify that http protocol is displayed in asx file for a SVP containg .mp3 file with HTTP delivery option and SL disabled.",date,utilityFunction.assertTextContains(htmlsource, "http://" + VAR_AP_Host + ":80/" + VAR_AP_MountPoint));
			utilityFunction=null;
		}catch(Exception e){
			e.printStackTrace();}
			 finally{
