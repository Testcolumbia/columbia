...
public class SVP_Content_Storage_Report extends TesterAsserter {
	...
	public void test_SVP_Content_Storage_Report() throws Exception {
		{
			try {
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
    	    ...
    	    assertTrue("SVP_Content_Storage_Report","Social VP: Ensure that 'Content Storage' report is generated.",date, selenium.isTextPresent("Content Storage Report"));
		   // stop selenium
    	    utilityFunction=null;
		}catch(Exception e){
			e.printStackTrace();}
