...
public class CVP_img_upload extends TesterAsserter {
	...
	public void test_CVP_img_upload() throws Exception {
		{
			try {
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			assertTrue("CVP_img_upload","Classic VP: Ensure that image file is uploaded in Content page.",date,selenium.isTextPresent(VAR_imgName));			
			utilityFunction=null;
		}catch(Exception e){
			e.printStackTrace();}
			 finally{
