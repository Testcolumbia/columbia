	...
	public void test_CVP_liveProgramAudience() throws Exception {
		{
			...
			//Create_Program.test_Live_audience(selenium, "CVP_liveProgramAudience", Var_LiveProgramName, VAR_RSSv5EncoderName, VAR_RSSv5EncoderProfileName, VAR_SlideDisplayName, VAR_PollName, VAR_SurveyName, VAR_audienceName);
			...
			assertTrue("CVP_liveProgramAudience","Verify that Poll is submitted successfully from the viewer portal.",date,selenium.isTextPresent("Your response has been submitted.\n\nYou may now close this window."));
			...
			assertTrue("CVP_liveProgramAudience", "Verify that user is able to push the results to the viewer portal", date, true);
			...
			assertTrue("CVP_liveProgramAudience","Verify that asx file is generated successfully.",date,utilityFunction.assertTextContains(htmlsource2, VAR_RSSv5EncoderProfileName));
			assertTrue("CVP_liveProgramAudience","Verify that mms protocol is displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource2, "mms"));
			assertTrue("CVP_liveProgramAudience","Verify that multicast stream is displayed in asx file.",date,utilityFunction.assertTextContains(htmlsource2, "http://" + VAR_WMSHost +"/WMSControl"));
			...
			assertTrue("CVP_liveProgramAudience","Verify that viewer question is displayed successfully on LBC.",date,selenium.isElementPresent(EnvObjectMap_Rep.img_audienceQuestionLBC));
			//Stop the broadcast 
