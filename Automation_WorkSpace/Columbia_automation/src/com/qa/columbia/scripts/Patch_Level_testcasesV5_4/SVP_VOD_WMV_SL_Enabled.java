...
public class SVP_VOD_WMV_SL_Enabled extends TesterAsserter {
	...
	public void test_SVP_VOD_WMV_SL_Enabled() throws Exception {
		{
			try {
			setUp();
			Utility_Functions utilityFunction = new Utility_Functions();
			...
			selenium.type(EnvObjectMap_Rep.TXT_Search_Name, VAR_WMV_fileName);
			...
			utilityFunction.waitForChangesToReflect();
			utilityFunction.waitForChangesToReflect();
			if(!selenium.isTextPresent(VAR_WMV_fileName))
			{
