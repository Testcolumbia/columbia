...
public class CVP_vod_SurveySummaryReport extends TesterAsserter {
	...
	public void test_CVP_vod_SurveySummaryReport() throws Exception {
		{
       	...
       	//Add a streaming media
            ...
            //Verify that the report is generated
	   		assertTrue("CVP_vod_SurveySummaryReport","Classic VP: Ensure that 'On Demand Survey Summary' report is generated.",date,selenium.isTextPresent("On-Demand Program Survey Summary Report"));        	
	   		utilityFunction=null;
		}catch(Exception e){
			e.printStackTrace();}
			 finally{
