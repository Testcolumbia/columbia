...
package com.qa.columbia.repository.v5_3;
...
//***************************Admin Portal*****************************//
	...
	static final String LNK_Password ="//input[@name='password']";
	
	//Object Map declaration for Login button
	 
	static final String BTN_LOGIN = "//button[@type='submit']";
	...
	static final String dropdown_Domain = "//select[@name='domainId']";
	...
	//Object map for Schedule Processes
	
	static final String LNK_scheduleProcesses = "link=Scheduled Processes";
	
	//Object map for Run now
	
	static final String LNK_runNowarchiveDiscovery2k = "//div[@id='12']/div[7]/a";
...
//**********************************Classic Viewer Portal****************************//     
    ...
    static final String lnk_LoginCVP = "link=Login";
...
//**********************************Social Viewer Portal****************************//    
  ...
  //  static final String LST_Searchresult = "//div[@id='jukebox']/div[6]/div/div/div/a[1]";
   ...
   // Link for Poll window on SVP
	...
	static final String CHK_PollWindow ="//div[@id='mpi_vp_Polls_0']/div[2]/div[2]/form/input[2]";
	
	// Submit button on Poll window
	static final String BTN_PollWindow ="Submit";
