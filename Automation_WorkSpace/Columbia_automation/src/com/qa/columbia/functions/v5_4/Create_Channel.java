...
{	
	...
	//	Date date=Calendar.getInstance().getTime();
		...
		//wait for loading the page
		sel.waitForPageToLoad(VAR_MED_WAIT);				
		//verifies the checkpoint for successful Channel Creation
		//assertTrue("Columbia_LiveProgramVerification","Verify that channel is created succesfully.",date,sel.isTextPresent(str_ChannelName));	
	}
}
