...
public class Create_WMS extends TesterAsserter {
    ...
    public static void create_WMS(Selenium sel,String str_WMS_name, String str_WMShost, String str_HTTPport, String str_webServiceUsername, String str_webServicePWD,String str_DeliveryType,String str_AppType,String Appname) throws Exception	{
		...
		sel.addSelection(EnvObjectMap_Rep.SelectType_DO_WMS, str_DeliveryType);
		//Select WMS option
		...
		sel.addSelection(EnvObjectMap_Rep.SelectType_AP,str_AppType);
		...
		sel.type(EnvObjectMap_Rep.TXT_APName,Appname);
