...
public class RSS_discovery {
	...
	public static void Add_4kdevice(Selenium sel, String str_rssDeviceName, String str_hostIP, String str_userName, String str_password) throws Exception {
	...
	public static void DeleteAll_RSSDiscoveryConfigurations(Selenium sel)
	{
		
	        //Click on Programming menu
	        sel.click(EnvObjectMap_Rep.Lnk_programming);
	        //Click on Polycom RSS Discovery
	        sel.click(EnvObjectMap_Rep.Lnk_polycomRSSDiscovery);
	        //Wait for the page to load
	        sel.waitForPageToLoad("60000");
	        sel.click(EnvObjectMap_Rep.chk_selectAllChannel);
	        if(sel.isEditable(EnvObjectMap_Rep.btn_deleteChannel)){
	            sel.click(EnvObjectMap_Rep.btn_deleteChannel);
	            sel.click(EnvObjectMap_Rep.Btn_rssdicoveryDeleteConfirmation);
	            sel.waitForPageToLoad("60000");   
	        }
	    }
