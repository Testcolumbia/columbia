...
public static void create_domainSocial(Selenium sel, String str_domainid, String str_domainname, String str_SiteURL) throws Exception {
		...
		sel.select(EnvObjectMap_Rep.Drp_securityRealm, "label=defaultdomain");
		...
		//Select enable EGC
		sel.click(EnvObjectMap_Rep.Chk_enableEGC);
...
public static void create_HTTP(Selenium sel,String str_HTTPName, String str_HTTPhost,String str_HTTPmpName, String str_storageName) throws Exception {
		...
		String VAR_DeliveryType_Download = utilityFunction.GetValue(local_path ,"VAR_DeliveryType_Download");	
...
public static void Add_pollOrSurvey(Selenium sel, String str_surveyName, String str_questionName, String str_questionExplanation, String str_questionType) throws Exception {
...
public static void Upload_Slides(Selenium sel,String str_SlideName, String str_Upload_Content) throws Exception	{	
	...
	sel.click(EnvObjectMap_Rep.Btn_AddItem);
	//Wait for loading the page
	utilityFunction.waitForElementToVisible(sel, EnvObjectMap_Rep.Radio_Slides, 300);
	//Select Slides radio button
	sel.click(EnvObjectMap_Rep.Radio_Slides);
	//Click next button
	sel.click(EnvObjectMap_Rep.Btn_next);
	utilityFunction.waitForElementToVisible(sel, EnvObjectMap_Rep.TXT_Selected_File, 300);
