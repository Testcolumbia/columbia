...
public class Create_storage extends TesterAsserter{
	...
	public static void create_storage(Selenium sel, String str_StorageName, String str_StorageHost, String str_mountPoint) throws Exception	{
		...
		String VAR_Storage = utilityFunction.GetValue(str_path ,"VAR_Storage");
		...
		//Storage Path
		String storage_Path = "\\\\" + str_StorageHost + "\\" + VAR_Storage;
		...
		assertTrue("Columbia_LiveProgramVerification","Verify that storage is created successfully.",date,sel.isTextPresent(str_StorageName));		
	}
